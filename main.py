...
set_push = [False, False, True, True, True, True, True]

# 最小步数（如果只需要刷步的次数少于7次就将该次数以后的步数全都改成0，如：time_list[3]: 0，表示第五次开始不运行或者直接云函数触发里面不在该时间调用均可（建议用后者））
min_dict = {time_list[0]: 1500, time_list[1]: 5000, time_list[2]: 10000, time_list[3]: 15000, time_list[4]: 20000, time_list[5]: 25000, time_list[6]: 30000}
